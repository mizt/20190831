/*
    ...
    clang++ -std=c++17 -Wc++17-extensions -fobjc-arc -O3 -framework Metal -framework QuartzCore -framework Cocoa -framework CoreMedia -I../libs/libjpeg-turbo -L../libs/libjpeg-turbo -lturbojpeg JPEG.mm -o JPEG
    ./JPEG
*/
